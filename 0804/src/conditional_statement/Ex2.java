...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		if(num < 0) { // 조건식
			// 조건식 결과가 true 일 때 실행 할 문장들...
			System.out.println("음수이므로 양수로 변환!"); // 문장2
			num = -num;
		} else {
			// 조건식 결과가 false 일 때 실행 할 문장들...
		...
		// 홀수 : 정수 num2 를 2로 나눈 나머지가 1일 경우(1과 같은 경우)
		// 짝수 : 정수 num2 를 2로 나눈 나머지가 0일 경우(0과 같은 경우)
		
		// if문을 사용하여 홀수일 경우 "num은 홀수!" 출력하고
		// 아니면(짝수일 경우) "num은 짝수!" 출력
		if(num2 % 2 == 1) { // 홀수일 경우 // num2 % 2 > 0 과 동일한 조건식
