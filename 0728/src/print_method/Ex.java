...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *    데이터를 각각 명시함
		 *    ex) printf("출력할 데이터형식", 데이터1, 데이터2, ..., 데이터n); 
		 */
		...
		System.out.print(1);
		System.out.println();
//		System.out.print(); // () 안에 내용을 반드시 넣어야 함! 그렇지 않으면 오류 발생!
		System.out.println("------------------------");
...
//		System.out.printf(1);
		...
		// 형식 지정 문자를 사용한 prinf() 메서드
		// %d : 10진수 1개 표현
		// %xd : x자릿수만큼의 자리를 차지
		// %0xd : x자릿수만큼의 자리를 차지하고, 빈자리는 0으로 채움
		// => ex) ...printf("%02d",2) -> 02 
		...
		System.out.printf("오늘 날짜는 %d년 %02d월 %d일 입니다.", 2022, 7, 28);
